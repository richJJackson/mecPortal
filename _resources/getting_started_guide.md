...
description:  A starters guide to PSCs
...
<section class="causal-grid">
  ...
  <section>
    <div class="content">
      <h3>Policymakers</h3>
      <p>Get policy-facing evidence summaries and interpretation guidance for decisions.</p>
      <ul>
        <li>What PSC evidence can support</li>
        <li>How uncertainty should be read</li>
...
<div class="box-round">
  <h2>Interactive Demo Ideas</h2>
  <ul>
    <li><b>How to use shiny pages:</b> Different inputs etc.</li>
    <li><b>How to use psc package</b> </li>
    <li><b>other</b> other.</li>
  </ul>
</div>

<div class="box-round">
  <h2>Quick Start in 15 Minutes</h2>
  <ol>
    <li>Read a short PSC overview.</li>
    <li>Run one interactive demo.</li>
