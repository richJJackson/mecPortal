...
<tbody>
  ...
  <div class="6u 12u$(medium)">
    <!-- Image -->
    <span class="image fit"><img src="{% link assets/images/Tace_datasumm_AV.png %}" alt="" /></span>
  </div>
     <!-- End Image -->
  </div>
<p>
...
<div class="row 200%">
    ...
    <div>
      <h3>Model Fit</h3>
      The figure shows the comparison between the observed Kaplan–Meier survival estimates and the fitted flexible parametric survival model. The Kaplan–Meier curve represents the observed survival, while the smooth blue curve represents the survival function estimated from the flexible parametric model using restricted cubic splines. The close agreement between the fitted model and the Kaplan–Meier estimates indicates good overall model fit and suggests that the flexible parametric model adequately captures the underlying survival pattern in the cohort.
      <span class="image fit"><img src="{% link assets/images/Tace_os_KM_vs_FPM_plot.png %}" alt="" /></span>
    </div>
